...
/*
This is just a plain `for-loop` that copies characters from one
array to another.
*/
...
/*
This is called Duff's device, named after Tom Duff, the person to
blame for this delicious evil.
*/
...
/*
A version of Duff's device that just uses a goto so you can clue
